...
| Held-out baseline comparison | Main final result. | Which policy had highest held-out profit? | results/key_figures/heldout_policy_comparison.png | report and presentation |
